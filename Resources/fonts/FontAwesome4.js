...
/*
 * FontAwesome Cheetsheet Wrapper (jQuery)
 * Website to run Wrapper at Firebug or Google Developer Tools
 * http://fortawesome.github.io/Font-Awesome/cheatsheet/
   var fontawesome = {};
   $('.col-md-4.col-sm-6.col-lg-3').each(function(){
     var k = $(this).text().match(/fa-.+/)[0].split(' ');
     k = k[0];
     var v = $(this).text().match(/&#.+/)[0].split(' ');
     v = v[0];
     v = v.replace('&#', '0');
     v = v.replace(';]', '');
     fontawesome[k] = v;
